...
def predict_single_text(text, model_path='./saved_en_bert_model/', label_map=None):
...
def process_metadata(metadata_path, model_path='./saved_en_bert_model'):
    label_map_path="./saved_en_bert_model/label_map.json"
